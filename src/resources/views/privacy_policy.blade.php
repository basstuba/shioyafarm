...
@section('content')
    <div class="privacy-policy">
        <div class="container">
            ...
            <section class="section">
                <h3 class="section-title">第6条（個人情報の開示）</h3>
                <ol>
                    <li>
                        <p class="section-text">
            ...
            <section class="section">
                <h3 class="section-title">第7条（個人情報の訂正および削除）</h3>
                <ol>
                    <li>
                        <p class="section-text">
            ...
            <section class="section">
                <h3 class="section-title">第8条（個人情報の利用停止等）</h3>
                <ol>
                    <li>
                        <p class="section-text">
            ...
            <section class="section">
                <h3 class="section-title">第9条（プライバシーポリシーの変更）</h3>
                <ol>
                    <li>
                        <p class="section-text">
